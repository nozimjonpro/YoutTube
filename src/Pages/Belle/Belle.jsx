...
function Belle({isOpen, setIsOpen}) {
    ...
    <section className="nora">
      <div className={`container ${isOpen? 'hidden-section' : ''}`}>
        <img
          ...
          height={280}
        />
        <Chanel heading="Belle Briggs" image={belle}></Chanel>
        <MainPart></MainPart>

        <Drink isOpen={isOpen} setIsOpen = {setIsOpen} heading="Belle Briggs videos"></Drink>
      </div>
<Routes>
